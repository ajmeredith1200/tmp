...
module "security_ap-southeast-4" {
  ...
  fw_external_security_group_name = "cwan-ased-prd-sg-fwmgmt-01"
  fw_internal_security_group_name = "cwan-ased-prd-sg-fwmgmt-02"
  ...
  fw1_size                      = "c7i.large" #t2.small not available in ap-southeast-4
  fw2_size                      = "c7i.large" #t2.small not available in ap-southeast-4
  ...
  natgw1_external_pip           = data.terraform_remote_state.cwan_persistent_remote_state.outputs.ap_southeast_4_nat1_external_pip
  natgw2_external_pip           = data.terraform_remote_state.cwan_persistent_remote_state.outputs.ap_southeast_4_nat2_external_pip
