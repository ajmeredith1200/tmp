...
module "security_ap-southeast-2" {
  ...
  fw_external_security_group_name = "cwan-aseb-prd-sg-fwmgmt-01"
  fw_internal_security_group_name = "cwan-aseb-prd-sg-fwmgmt-02"
  ...
  natgw1_external_pip           = data.terraform_remote_state.cwan_persistent_remote_state.outputs.ap_southeast_2_nat1_external_pip
  natgw2_external_pip           = data.terraform_remote_state.cwan_persistent_remote_state.outputs.ap_southeast_2_nat2_external_pip
