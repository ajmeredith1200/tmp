variable "fw1_external_pip" {
  description = "ID of PIP for FW1"
  type        = string
}

variable "fw2_external_pip" {
  description = "ID of PIP for FW2"
  type        = string
}

variable "natgw1_external_pip" {
  description = "ID of PIP for NAT GW1"
  type        = string
}

variable "natgw2_external_pip" {
  description = "ID of PIP for NAT GW2"
  type        = string
}
...
variable "external_route_table_name" {
  description = "Name of the route table for the external subnets"
  type        = string
}

variable "gwlb_a_route_table_name" {
  description = "Name of the route table for the GWLB A subnet"
  type        = string
}

variable "gwlb_b_route_table_name" {
  description = "Name of the route table for the GWLB B subnet"
  type        = string
}

variable "attachment_a_route_table_name" {
  description = "Name of the route table for the attachment_a subnet"
  type        = string
}

variable "attachment_b_route_table_name" {
  description = "Name of the route table for the attachment_b subnet"
  type        = string
}

variable "nat_gw_a_route_table_name" {
  description = "Name of the route table for the nat_gw_a subnet"
  type        = string
}

variable "nat_gw_b_route_table_name" {
  description = "Name of the route table for the nat_gw_b subnet"
  type        = string
}
...
variable "core_network_id" {
  description = "ID of the Cloud WAN core network to attach this VPC to"
  type        = string
}

variable "core_network_arn" {
  description = "ARN of the Cloud WAN core network used by the gwlb route table"
  type        = string
}

variable "attachment_tags" {
  description = "Tags applied to the Cloud WAN VPC attachment"
  type        = map(string)
  default     = {}
}

variable "subnets" {
  description = "Subnets to create in the Security VPC"
  type = map(object({
    name = string
    cidr = string
  }))
...
# Gateway Load Balancer (GWLB) related variables
variable "gwlb_name" {
...
variable "gwlb_target_group_name" {
  description = "Name of the target group for the GWLB"
  type        = string
  default     = "fgt-target-group"
}

# FortiGate VM related variables

variable "fw_external_security_group_name" {
  description = "Name of the external security group for the FortiGate VM instances"
  type        = string
  default     = "fgt-sg"
}

variable "fw_internal_security_group_name" {
  description = "Name of the internal security group for the FortiGate VM instances"
  type        = string
  default     = "fgt-sg"
}

variable "fw1_hostname" {
  description = "Name of the first FortiGate VM instance"
  type        = string
  default     = "fgtvm-1"
}
...
variable "fw1_instance_name" {
  description = "Name of the first FortiGate VM instance"
  type        = string
  default     = "fgtvm-1"
}

variable "fw2_instance_name" {
  description = "Name of the second FortiGate VM instance"
  type        = string
  default     = "fgtvm-2"
}

variable "fw1_size" {
  description = "Instance type for the first FortiGate VM"
  type        = string
  default     = "t2.small"
}
variable "fw2_size" {
  description = "Instance type for the second FortiGate VM"
  type        = string
  default     = "t2.small"
}
...
variable "az1" {
  description = "Availability zone 1 for the security VPC and FortiGate VM instances"
  type    = string
}

variable "az2" {
  description = "Availability zone 2 for the security VPC and FortiGate VM instances"
  type    = string
}
...
variable "bootstrap-fgtvm" {
  ...
  type    = string
  default = "../../modules/security/firewall.conf"
}